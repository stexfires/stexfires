...
/**
 * A RecordMapper maps a {@link stexfires.core.TextRecord} to another record.
 * <p>
 * It must be {@code thread-safe} and {@code non-interfering}.
 * It should be {@code immutable} and {@code stateless}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #map(stexfires.core.TextRecord)}.
 *
 * @author Mathias Kalb
